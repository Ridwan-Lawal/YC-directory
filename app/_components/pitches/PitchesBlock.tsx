...
export default async function PitchesBlock({ query }: { query: string }) {
  ...
  return (
    <div className="grid items-center  gap-7 sml:grid-cols-2 sm:max-w-[700px] lg:max-w-[1280px] mx-auto lg:grid-cols-3 xl:grid-cols-4 border border-green-500 w-fit">
      {pitches?.map((pitch) => (
